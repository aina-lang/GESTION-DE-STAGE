...
<body>
    <div class="main-wrapper">
        <div class="header">
            <div class="header-left" style="justify-content: space-between;justify-items:center;">
                    ...
                    <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                        <span class="user-img">
                            ...
                            <div class="user-text">
                                ...
                                <p class="mb-0 text-muted">{{ Session::get('role_name') }}</p>
                            </div>
                        </span>
                    </a>
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="{{ route('user/profile/page') }}">Mon Profile</a>
                        <a class="dropdown-item" href="{{ route('logout') }}">Deconnecter</a>
                    </div>
                </li>
            </ul>
        </div>
        ...
        @yield('content')
        <footer>
            <p>Creer © {{ \Carbon\Carbon::now()->year }} Jonathan.</p>
        </footer>
    ...
    <script src="{{ URL::to('assets/plugins/chartjs/chart-data.js') }}"></script>
